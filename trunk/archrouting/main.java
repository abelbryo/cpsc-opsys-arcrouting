public class main {
	...
	public static void main(String[] args)
	{
 	...
 	// char  vertexList[];
		...
		map1.addVertex('3');
		map1.addVertex('4');
		map1.addArc(0, 1 ,"a",  500000 ,5 , 1);
		map1.addArc(1, 2 ,"b",  0 ,0 , 2);
		//map1.addArc(1, 2 ,"b", 0, 17 ,8 , 2);
		map1.addArc(2, 3 ,"c",  1 ,9 , 5);
		map1.addArc(1, 3 ,"d", 6 ,7 , 3);
		map1.addArc(3, 4 ,"e",  2 ,50 , 1);
...
//
	...
	//	}
		...
		//for(int j=0; j<arc1.length;j++)
	//	{
		//	System.out.println(arc1[j].getTitle());
	//	}
